...
# MODIFIABLE LIFESTYLE: Find relationships between insurance cost and bmi, smoker, alcohol_freq, exercise_frequency, sleep_hours, stress_level
# BASELINE DEMOGRAPHIC AND SOCIOECONOMIC FACTORS: Find relationships between insurance cost and age, sex, education, income, marital_status, household_size
---
```{r}
library(tidyverse)
```
